...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_karya_budayas', function (Blueprint $table) {
            $table->uuid('id_karya_budaya')->primary();
            $table->string('nama_karya', 200)->nullable();
            $table->string('jenis_karya', 150)->nullable(); //ada opsi
    ...
    {
        Schema::dropIfExists('tbl_karya_budayas');
    }
};
