<div>
    ...
    <div class="theme-settings__options-wrapper">
        <h3 class="d-flex">
            ...
            <button type="button"
                class="btn-pill btn-shadow btn-wide ms-auto btn btn-focus btn-sm switch-header-cs-class" data-class="">
                Pengaturan Awal
            </button>
        </h3>
        <x-card>
            <h5 class="pb-2">Pilih Tema Header</h5>
            ...
            <div class="theme-settings-swatches">
                ...
                <div class="swatch-holder bg-malibu-beach switch-header-cs-class"
                    data-class="bg-malibu-beach header-text-dark">
                </div>
        ...
        <x-card>
            <h5 class="pb-2">Pilih Tema Sidebar
            </h5>
            <div class="theme-settings-swatches">
                ...
                <div class="swatch-holder bg-success switch-sidebar-cs-class"
                    data-class="bg-success sidebar-text-light">
                </div>
                <div class="swatch-holder bg-info switch-sidebar-cs-class" data-class="bg-info sidebar-text-light">
                </div>
                ...
                <div class="swatch-holder bg-amy-crisp switch-sidebar-cs-class"
                    data-class="bg-amy-crisp sidebar-text-light">
                </div>
                <div class="swatch-holder bg-heavy-rain switch-sidebar-cs-class"
                    data-class="bg-heavy-rain sidebar-text-dark">
                </div>
                <div class="swatch-holder bg-mean-fruit switch-sidebar-cs-class"
                    data-class="bg-mean-fruit sidebar-text-light">
                </div>
        ...
        {{-- <h3 class="d-flex">
            <div>Pengaturan Halaman Utama</div>
            <button type="button"
                class="btn-pill btn-shadow btn-wide ms-auto btn btn-focus btn-sm switch-sidebar-cs-class"
                data-class="">
                Restore Default
            ...
            <div class="row row-cols-lg-3">
                <div class="col">
                    <input type="file" class="dropify"
                        data-default-file="{{ asset('storage/profile/default.jpg') }}" />
                </div>
                <div class="col">
                    <input type="file" class="dropify"
                        data-default-file="{{ asset('storage/profile/default.jpg') }}" />
...
@push('script')
    <script>
        ...
        $('.switch-sidebar-cs-class').on('click', function() {
            ...
            @this.themeSidebar(cls);
        });

        $('.switch-header-cs-class').on('click', function() {
            var cls = $(this).attr('data-class');
            @this.themeHeader(cls);
        });
    </script>
@endpush
