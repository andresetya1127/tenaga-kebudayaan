    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 my-4">
                <h4 class="text-center">Daftar Karya Budaya Di Kabupaten Lombok Tengah</h4>
            </div>
            <div class="input-group" wire:ignore>
                <div class="form-outline" data-mdb-input-init>
                    <input type="text" class="form-control search-input" wire:model.live='search' />
                    <label class="form-label" for="">Cari Karya Budaya</label>
                </div>
            </div>
                ...
                <div class="table-responsive my-5">
                    <table class="table table-hover" style="width: 100%;">
                        ...
                        <tbody class="table-group-divider table-divider-color">
                            @forelse ($data as $dt)
                                <tr wire:click="detailKaryaBudaya('{{ $dt->id_karya_budaya }}')" class="align-middle">
                                    <td>{{ $loop->index + $data->firstItem() }}</td>
                                    <td>{{ $dt->nama_karya }}</td>
                                    <td>{{ $dt->nama_pencipta }}</td>
                                    <td>{{ $dt->jenis_karya }}</td>
