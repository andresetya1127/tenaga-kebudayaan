    ...
    <div class="container">
        <div class="row">
            <div class="col-12 my-4">
                <h4 class="text-center">Daftar Cagar Budaya Di Kabupaten Lombok Tengah</h4>
            </div>
            <div class="input-group" wire:ignore>
                <div class="form-outline" data-mdb-input-init>
                    <input type="text" class="form-control search-input" wire:model.live='search' />
                    <label class="form-label" for="">Cari Cagar Budaya</label>
                </div>
            </div>
            ...
            <div class="row row-cols-lg-3 g-4">
                ...
                <div class="col">
                    ...
                    <select class="form-control" wire:model.live='jenisCagar'>
                        ...
                        <option selected value="Benda">Benda</option>
                        <option selected value="Tak Benda">Tak Benda</option>
                ...
                <div class="table-responsive my-5">
                    <table class="table table-hover" style="width: 100%;">
                        ...
                        <tbody class="table-group-divider table-divider-color">
                            @forelse ($data as $dt)
                                <tr wire:click="detailCagarBudaya('{{ $dt->id_cagar }}')">
