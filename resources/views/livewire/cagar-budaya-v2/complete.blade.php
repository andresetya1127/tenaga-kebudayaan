        ...
        @if ($step == 1)
            <form wire:submit.prevent='nextStep'>
                <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1">
                    ...
                    <x-input key='satuan_waktu' label="Satuan Waktu Pembuatan" wire:model.blur='form.satuan_waktu' />

                    <x-input key='priode_waktu' label="Priode Waktu Pembuatan" wire:model.blur='form.priode_waktu' />
        ...
        @if ($step == 3)
            <form wire:submit.prevent='nextStep'>
                <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1">
                    ...
                    <x-input type="number" key='tahun_pendataan' label="Tahun Pendataan"
                    ...
                    <x-input type="number" key='tahun_penetapan' label="Tahun Penetapan"
                ...
                {{-- <div class="row row-cols-2 row-cols-md-4">
                    <div class="col">
                        ...
                        @else
                            <div class="border border-primary p-3 rounded text-center">
                                <a href="" class="text-nowrap text-ellips-0" target="_blank">
                                    {{ $form->dokumen }}
                                </a>
