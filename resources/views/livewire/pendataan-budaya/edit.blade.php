            ...
            <div class="d-flex align-items-center justify-content-center">
                @if ($form->foto)
                    <div class="position-relative" style="width: 450; height: 250px">
                        ...
                        <img src="{{ $form->fotoPush ?? false ? $form->fotoPush : asset('storage/photos/' . $form->foto) }} "
        ...
        <div class="col-12">
            <x-card>
                ...
                <div class="row row-cols-lg-3 g-3 mt-3">
                    ...
                    <!--NIK-->
                    <x-input type="number" label="NIK" key="nik" wire:model='form.nik'
                        place="Masukkan NIK..." />
                    ...
                    <div class="col">
                        ...
                        <div wire:ignore>
                            <select id="bidang" class="select-tags form-control" multiple
                                placeholder="Pilih Bidang..." wire:model='form.bidang'>
                                @foreach ($bidang as $key => $val)
                                    <optgroup label="{{ $key }}">
                                        @foreach ($val as $k)
                                            <option value="{{ $k }}"
                                                {{ in_array($k, $form->bidang) ? 'selected' : '' }}>
                                                {{ $k }}
                                            </option>
                                        @endforeach
                                    </optgroup>
        ...
        <div class="col-12">
            <x-card>
                ...
                <div class="row row-cols-lg-2 g-3 mt-3">
                    ...
                    <!--Email-->
                    <x-input tp="text" label="Email" key="email" wire:model='form.email'
                        place="Masukkan Email Valid..." />

                    <!--Facebook-->
                    <x-input tp="text" label="Facebook" key="facebook" wire:model='form.facebook'
                        place="Masukkan Nama Facebook.." />

                    <!--Instagram-->
                    <div class="col">
                        <x-input tp="text" label="Instagram" key="instagram" wire:model='form.instagram'
                            place="Masukkan Nama Instagram.." />
                    </div>

                    <!--Youtube-->
                    <x-input tp="text" label="Youtube" key="youtube" wire:model='form.youtube'
