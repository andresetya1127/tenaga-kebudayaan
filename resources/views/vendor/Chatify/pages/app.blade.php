...
<div class="messenger">
    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-body contacts-container">
            ...
            <div class="show messenger-tab users-tab app-scroll" data-view="users">
                ...
                {{-- Saved Messages --}}
                <p class="messenger-title"><span>Pesan diri sendiri</span></p>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <nav class="m-header-right">
                    ...
                    <a href="{{ route('landing.dashboard') }}"><i class="fas fa-home"></i></a>
            ...
            <div class="internet-connection">
                ...
                <span class="ic-connecting">Menyambungkan...</span>
        ...
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Silahkan Pilih pengguna untuk memulai pesan.</span></p>
            </div>
            {{-- Typing indicator --}}
