...
<div class="app-modal" data-name="delete">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="delete" data-modal='0'>
            <div class="app-modal-header">Apakah anda yakin ingin menghapus pesan ini?</div>
            <div class="app-modal-body">Pesan akan dihapus permanen</div>
            <div class="app-modal-footer">
                <a href="javascript:void(0)" class="app-btn cancel">Batal</a>
                <a href="javascript:void(0)" class="app-btn a-btn-danger delete">Ya, Hapus.</a>
            </div>
        </div>
    </div>
</div>
